...
driver.get("https://dataservice.koscom.co.kr/krx/100617/approval-detail")

span_iconset_icon_down_attach = driver.find_element_by_class_name("span.iconset.icon-down-attach")
span_iconset_icon_down_attach.click()
